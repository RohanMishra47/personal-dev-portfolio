        ...
        <div className="mb-8">
          <div className="flex flex-col gap-4 mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-xl shadow-sm hover:bg-gray-50 transition-colors"
            >
              <Filter size={20} />
              Filters
          ...
          {filteredPosts.map((post) => (
            ...
            >
              <div className="p-6">
                ...
                <button
                  onClick={() => handleReadMore(post.slug)}
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-3 px-6 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg group"
                >
                  Read More
                  <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </button>
