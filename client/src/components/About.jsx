...
import { FaGithub, FaLinkedin, FaFileDownload, FaAddressBook } from "react-icons/fa";
...
const About = () => {
  ...
  const skills = ['JavaScript', 'React', 'Node.js', 'Backend Development', 'Problem Solving', 'Quick Learning'];
        ...
        <motion.div 
          ...
          <motion.div 
            ...
            {aboutData.socials?.github && (
              <a href={aboutData.socials.github} target="_blank" rel="noreferrer" className="btn btn-primary">
                <FaGithub /> GitHub
              </a>
            )}
            {aboutData.socials?.linkedin && (
              <a href={aboutData.socials.linkedin} target="_blank" rel="noreferrer" className="btn btn-secondary">
                <FaLinkedin /> LinkedIn
              </a>
            )}
            {aboutData.resume && (
            ...
            {aboutData.contact && aboutData.contact[0] && (
              <Link to={aboutData.contact[0].url} className="btn btn-primary contact-link">
